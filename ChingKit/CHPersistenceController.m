...
@interface CHPersistenceController()
...
@implementation CHPersistenceController
...
- (void)initializeCoreData
{
	...
	NSURL *modelURL = [[NSBundle bundleForClass:[CHPersistenceController class]] URLForResource:@"DataModel" withExtension:@"momd"];
